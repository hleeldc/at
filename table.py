...
class TableModel(TableIo):
    ...
    def setColumnHeader(self, colIdx, colName, colType):
        ...
        @type colType: type
        """
        del self.str2col[self.header[colIdx][0]]
        self.header[colIdx] = (colName, colType)
        self.str2col[colName] = colIdx
...
if __name__ == "__main__":
    ...
    tab.insertColumn(1,[("extra",str),10,9])
    tab.printTable()
